...
class MainActivity : AppCompatActivity() {
    ...
    private val adapter by lazy { CartaoDeVisitasAdapter() }
    ...
    private fun insertListeners() {
        binding.fab.setOnClickListener {
            val intent = Intent(this, AddCartaoDeVisitasActivity::class.java)
    ...
    private fun getAllCartoesDeVisitas() {
        mainViewModel.getAll().observe(this, { cartoesDeVisitas ->
